...
#define PmcCompany "Cloversoft Servi?os de Inform¨¢tica Ltda"
#define PmcURL "https://www.macrocreator.com"
#define PmcCopyright "Copyright (C) 2012-2021 Cloversoft Servi?os de Inform¨¢tica Ltda"
#define PmcExeName "MacroCreator.exe"
#define PmcExt "pmc"
#define WorkDir "D:\IMPORTANT\Èí¼þ\Pulovers Macro Creator\¾É°æ±¾\PuloversMacroCreator-5.4.1"
